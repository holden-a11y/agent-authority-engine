...
const PageGeneratorTab = ({ agentName, market, socialUrls, entityConfig }: PageGeneratorTabProps) => {
  ...
  const bulkGenerate = async () => {
    ...
    try {
      ...
      const newPages: AeoPage[] = (data.pages || []).map((p: any) => ({
        id: crypto.randomUUID(),
        title: p.title,
      ...
      savePages(updated);
      toast({
        title: `${newPages.length} pages generated!`,
        description: data.summary || "Pages have been saved as drafts. Review and publish when ready.",
      });
    } catch (e: any) {
