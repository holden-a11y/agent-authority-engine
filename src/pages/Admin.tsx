...
const defaultConfig: EntityConfig = {
  ...
  targetNeighborhoods: ["East Grand Rapids", "Ada", "Cascade", "Rockford", "Hudsonville", "Byron Center", "Grandville", "Kentwood", "Caledonia", "Jenison"],
  schoolDistricts: ["EGR Schools", "Forest Hills", "Rockford Schools", "Hudsonville Schools", "Byron Center Schools", "Caledonia Schools", "Kenowa Hills", "Grandville Schools"],
  keyEmployers: ["Corewell Health", "Meijer", "Amway", "GE Aerospace", "Steelcase", "Gentex", "Van Andel Institute", "Grand Valley State University", "Mercy Health", "Gordon Food Service"],
  agentBio: "Holden Richardson is a Grand Rapids real estate agent specializing in relocation and premium school district communities. With deep local knowledge of West Michigan's neighborhoods, Holden helps families, professionals, and remote workers find the right home in the right community — whether that's walkable East Grand Rapids, suburban Ada and Cascade, or the top-rated Hudsonville and Rockford corridors.",
  voiceToneNotes: "Approachable, confident, data-informed but conversational. Speaks like a knowledgeable neighbor, not a salesperson. Uses local references naturally.",
  fubApiKey: "",
  ...
  usps: ["Relocation specialist — helps out-of-state buyers navigate GR remotely", "Deep school district expertise across Kent & Ottawa counties", "Data-driven market analysis for every neighborhood", "Video-first content creator — YouTube walkthroughs of every community"],
  certifications: [],
  yearsExperience: "",
  clientPersonas: ["Relocating families moving to GR for healthcare or manufacturing jobs", "First-time homebuyers priced out of larger metros", "Remote workers seeking affordable Midwest lifestyle with outdoor access", "Move-up buyers targeting top school districts (Forest Hills, EGR, Rockford)", "Downsizers transitioning from suburban homes to walkable urban living"],
  localKnowledge: "Grand Rapids is Michigan's second-largest city and the economic hub of West Michigan. Known as 'Beer City USA' with 80+ craft breweries. The Medical Mile downtown anchors a $2B+ healthcare and life sciences corridor. Frederik Meijer Gardens is a world-class sculpture park. ArtPrize (now Project 1) put GR on the cultural map. Lake Michigan beaches are 30-40 minutes west. Millennium Park is one of the largest urban parks in the country. The GR food scene punches way above its weight — Brewery Vivant, The Chop House, Hancock. Winters are real (lake-effect snow) but the outdoor culture is strong — skiing at Cannonsburg, trails everywhere. East Grand Rapids has the walkable village feel with Reeds Lake. Ada is quiet luxury along the Thornapple River. Cascade blends suburban convenience with nature access.",
  recentStats: "",
  avgPriceRange: "$250,000 - $550,000",
  avgDaysOnMarket: "14-21 days",
  closedNeighborhoods: [],
  marketNuances: "Grand Rapids inventory remains tight, especially in the $250K-$400K range where demand is highest. The east side suburbs (Ada, Cascade, EGR) command significant premiums for Forest Hills and EGR school districts. New construction is concentrated in Caledonia, Byron Center, and Hudsonville. Downtown condos and Midtown/Eastown rentals are popular with young professionals. The market sees seasonal slowdowns Nov-Feb but multiple offers remain common in desirable school districts year-round.",
  competitiveLandscape: "GR is a competitive market with multiple-offer situations common in the $200K-$400K range and in top school districts. Buyers relocating from higher-cost metros (Chicago, Detroit, coastal cities) often have purchasing power advantages. Cash offers from investors have increased, particularly in the Kentwood and Wyoming corridors. The key differentiator for agents is hyper-local neighborhood expertise and speed of response.",
  currentChallenges: "Low inventory across all price points, particularly starter homes under $250K. Interest rates have moderated buyer urgency but haven't significantly reduced prices. Appraisal gaps remain a concern in fast-appreciating areas like Ada and Cascade. New construction timelines are long (6-10 months) and material costs keep prices elevated. Insurance costs rising statewide.",
};
